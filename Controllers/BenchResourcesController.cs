...
public class BenchResourcesController(LmsDbContext db, ICloudflareService r2) : ControllerBase
{
    ...
    static object Project(BenchResource r) => new
    {
        ...
        r.ExpectedCTC,
        r.Notes,
        profilePhotoUrl = r.ProfilePhotoUrl ?? (string?)null,
        resumeUrl = r.ResumeUrl ?? (string?)null,
        resumeFileName = r.ResumeFileName ?? (string?)null,
        panCardUrl = r.PanCardUrl ?? (string?)null,
        panCardNumber = r.PanCardNumber ?? (string?)null,
        aadhaarUrl = r.AadhaarUrl ?? (string?)null,
        aadhaarNumber = r.AadhaarNumber ?? (string?)null,
        otherDocumentsJson = r.OtherDocumentsJson ?? (string?)null,
        r.OrganizationId,
        r.CreatedAt,
        r.UpdatedAt
    };
